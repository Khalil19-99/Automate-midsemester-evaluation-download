...
for j in range(2,4):
    grades = (
            'http://10.90.105.115/moodle/webservice/rest/server.php?moodlewsrestformat=json&wsfunction=gradereport_user_get_grades_table&wstoken=d297cefc19e8ad71923fe5223a6a8164&courseid=' + str(
        j))
    ...
    for i in range(3):
        worksheet.write(chr(67+j) + str(i + 2), site.json()["usergrades"][i]["gradeitems"][id-1]["gradeformatted"])
